...
```bash
.venv/bin/python -m pytest tests/ -q       # 70 tests (root conftest.py makes bare `pytest` work too)
scripts/test-container.sh                  # same suite in the image that ships: 69 + 1 skipped (#33)
